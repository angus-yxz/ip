# Mona project template

This is a project template for a greenfield Java project. It's named after the Genshin Impact character _Mona_. Given below are instructions on how to use it.
